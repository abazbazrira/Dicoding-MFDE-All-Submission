...
void main() {
  ...
  late MockGetRecommendations mockGetMovieRecommendations;
  ...
  setUp(() {
    ...
    mockGetMovieRecommendations = MockGetRecommendations();
    mockGetWatchlistStatus = MockGetWatchListStatus();
    mockSaveWatchlist = MockSaveWatchlist();
    mockRemoveWatchlist = MockRemoveWatchlist();
    provider = DetailNotifier(
      getDetail: mockGetMovieDetail,
  ...
  final tMovies = <MovieTvShow>[tMovie];

  void _arrangeUsecase() {
    when(mockGetMovieDetail.execute(tId, movies))
        .thenAnswer((_) async => Right(testMovieDetail));
    when(mockGetMovieRecommendations.execute(tId, movies))
  ...
  group('Get Movie Detail', () {
    test('should get data from the usecase', () async {
      ...
      _arrangeUsecase();
      // act
      await provider.fetchDetail(tId, movies);
      // assert
      verify(mockGetMovieDetail.execute(tId, movies));
      verify(mockGetMovieRecommendations.execute(tId, movies));
    });
    ...
    test('should change state to Loading when usecase is called', () {
      ...
      _arrangeUsecase();
      // act
      provider.fetchDetail(tId, movies);
      // assert
