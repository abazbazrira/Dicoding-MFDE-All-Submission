...
// in dicoding_mfde_submission/test/presentation/provider/movie/movie_search_notifier_test.dart.
...
import 'package:dicoding_mfde_submission/domain/repositories/movie_tv_show_repository.dart'
    as _i2;
import 'package:dicoding_mfde_submission/domain/usecases/search.dart' as _i4;
...
class MockSearch extends _i1.Mock implements _i4.Search {
  MockSearch() {
  ...
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.MovieTvShow>>> execute(
      ...
      (super.noSuchMethod(Invocation.method(#execute, [query, type]),
              returnValue:
